...
function my_script_init() {
	...
	// Google Fonts
	wp_enqueue_style('Montserrat', '//fonts.googleapis.com/css2?family=Montserrat:wght@500;700;800&display=swap');
	// swiper
...
function wp_is_phone(){
	// ユーザーエージェント...OSやブラウザの情報
	// $_SERVER...ヘッダ情報、パス情報、スクリプトの位置のような情報を持つ。スーパーグローバル変数で連想配列で使用する。
